package com.hejun.bus.controller;
...
import com.hejun.bus.service.IProviderService;
import com.hejun.bus.vo.GoodsVo;
import com.hejun.sys.common.AppFileUtils;
...
public class GoodsController {
    ...
    public ResultObj updateGoods(GoodsVo goodsVo){
        try {
            //商品图片不是默认图片
            if (!(goodsVo.getGoodsimg()!=null&&goodsVo.getGoodsimg().equals(Constant.DEFAULT_IMG_GOODS))){

...
public class Constant {
    ...
    public static final String DEFAULT_IMG_USER="/root/upload/img/face001.jpg";

    /**
     * 商品默认图片
     */
    //public static final String DEFAULT_IMG_GOODS = "/images/noDefaultImage.jpg";
    public static final String DEFAULT_IMG_GOODS = "/root/upload/img/noDefaultImage.jpg";
